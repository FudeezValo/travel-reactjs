            ...
            <header className="header flex">
                ...
                <div className={`navbar ${active ? 'activeNavbar' : ''}`}>
                    <ul className="navLists flex">
                        ...
                        <li className="navItems"><a href="/" className="navLink">Packages</a></li>
                        <li className="navItems"><a href="/" className="navLink">Shop</a></li>
                        ...
                        <li className="navItems"><a href="/" className="navLink">Contact</a></li>
